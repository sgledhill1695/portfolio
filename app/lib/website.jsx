...
export default function Website({imgSrc, imgAlt, title, content, stack, href, codeHref, frontendCode, backendCode, videoEmbed, embed}){
    ...
    const [openModal, setOpenModal] = useState(false); //State to open/close embed modal
