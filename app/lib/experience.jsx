...
export default function Experience({navigation, setNavigation}){
    ...
    return(
        <>
            ...
            <a href="/downloads/samuel-gledhill-c-v.pdf" target="_blank" className="flex items-center gap-2 sans-bold tracking-widest text-[13px]  text-[white] hover:text-[#5EEAD4] fill-[white] hover:fill-[#5EEAD4] mt-[35px]">
